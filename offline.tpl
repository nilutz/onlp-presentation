...
<!-- locally -->
<script src='./CDNs/require.min.js'></script>
<script src='./CDNs/jquery.min.js'></script>
...
<!-- and locally -->
<script src='./CDNs/MathJax-2.6-latest/MathJax.js?config=TeX-AMS_HTML'></script>
<!-- Loading the mathjax macro -->
{{ mathjax() }}
<!-- Get Font-awesome from cdn -->
<link rel="stylesheet" href="{{resources.reveal.font_awesome_url}}">
<!-- and locally -->
<link rel="stylesheet" href="./CDNs/font-awesome-cdn.css">
...
require(
    ...
    function(head, Reveal){
        ...
        function setScrollingSlide() {
            ...
            var scroll = true
            if (scroll === true) {
              var h = $('.reveal').height() * 0.55;
              $('section.present').find('section')
                .filter(function() {
                  return $(this).height() > h;
                })
                .css('height', 'calc(72vh)')
